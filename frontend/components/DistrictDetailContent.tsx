    ...
    <div className="mt-10 space-y-6">
      ...
      <section className="rounded-xl border border-zinc-200 bg-white p-5 shadow-sm sm:p-6">
        <h2 className="text-lg font-extrabold text-blue-950">
          Reporting and Reference Numbers in {district}
        </h2>
        <div className="mt-3 space-y-3 text-sm leading-relaxed text-zinc-600">
          <p>
            Anyone experiencing a power cut anywhere in {district} can submit an anonymous report
            in under a minute — no account, phone number, or address needed beyond the PIN code
          ...
          <p>
            If you&apos;re unsure whether an outage in {district} is planned or a fault, check the{" "}
